...
import type { SlotsType, VNodeArrayChildren } from 'vue'
...
const buttonVariants = tv({
  ...
  variants: {
    ...
    size: {
      small: 'h-6 rounded gap-1 px-2 has-[>svg]:px-2',
      middle: 'h-8 rounded-md gap-1.5 px-4 py-2 has-[>svg]:px-3',
      large: 'h-10 rounded-lg gap-2 px-6 has-[>svg]:px-4',
    },
  },
  compoundVariants: [
    {
...
const Button = defineComponent<ButtonProps, ButtonEmits, string, SlotsType<ButtonSlots>>((props, ctx) => {
  ...
  props: ['variant', 'color', 'size', 'disabled', 'class'],
